  ...
  <div class="ContainDiv">
    <div class="LoginDiv">
      ...
      <div class="LoginItem">
        ...
        <div class="form">
          <el-input v-model="loginPwd" type="password" placeholder="Please input password" show-password />
        </div>
      </div>
      <div class="LoginItem">
      ...
      <div class="LoginItem">
        <div class="SubBtn">
          <el-button type="primary" color="#9df5e8f0" @click="AdminLogin">登入</el-button>
...
.ContainDiv {
  width: 100vw;
  height: 100vh;
  // background: linear-gradient(to top, #32323280, #5F9EA0);
  display: flex;
